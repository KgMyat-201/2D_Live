...
@section('content')
    ...
    <div class="card card-outline card-primary" id="app">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('users.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ Request::old('email') ?: '' }}" id="email" name="email" class="form-control"> @if ($errors->has('email'))
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" value="{{ Request::old('password') ?: '' }}" id="password" name="password" class="form-control"> @if ($errors->has('password'))
                ...
                <div class="form-group{{ $errors->has('confirm_password') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" value="{{ Request::old('confirm_password') ?: '' }}" id="confirm_password" name="confirm_password"
                            class="form-control"> @if ($errors->has('confirm_password'))
                ...
                <div class="form-group">
                    <div class="float-right">
                        ...
                        <a href="{{route('users.index')}}" class="btn btn-outline-secondary" type="button">Back</a>
                    </div>
                </div>
            </form>
        </div>
